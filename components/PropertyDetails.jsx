  ...
  return (
    <main>
      <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
        ...
        <h3 className="text-lg font-bold my-6 bg-gray-800 text-white px-3 py-2 rounded-lg">
          Rates & Options
        </h3>
        <div className="flex flex-col md:flex-row justify-around">
          <div className="flex items-center justify-center border-b border-gray-200 md:border-b-0 mb-4 pb-4 md:pb-0">
